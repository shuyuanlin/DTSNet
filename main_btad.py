...
from dataset.dataset import BTADDataset_train, BTADDataset_test
...
def get_args():
    ...
    parser.add_argument('--classes', nargs="+", default=['01'])
    parser.add_argument('--save_folder', default='./experiments/BTAD', type=str)
    parser.add_argument('--dataset_path', default='/home/sylin/LTX/datasets/BTAD', type=str)
...
def train(_class_, pars):
    ...
    test_data = BTADDataset_test(dataset_path=test_path, resize=(pars.image_size, pars.image_size))
...
if __name__ == '__main__':
    ...
    print('Training with classes: ', btad_classes)
    for c in btad_classes:
